...
import com.bytedance.tiktok.databinding.ActivityMainViewBindBinding;
 ...
 * 主页面
 */
public class MainActivity extends BaseActivity<ActivityMainViewBindBinding> {
        ...
        RxBus.getDefault().toObservable(MainPageChangeEvent.class)
                .subscribe((Action1<MainPageChangeEvent>) event -> {
                    if (binding.viewpager != null) {
                        binding.viewpager.setCurrentItem(event.getPage());
                    }
                });
